...
def classify(msg: str) -> str:
    ...
    motivation_keywords = [
        ...
        "i need motivation", "no drive", "no mood",
        "can't study", "dont feel like doing anything", "don't feel like doing anything"
    ]
...
def classify_api():
    try:
        ...
        replies = {
            ...
            "fallback": "I'm not fully sure which category fits best. Please choose the option that feels closest to what you're experiencing."
        }
        ...
        return jsonify({
            "received_message": "",
            "category": "fallback",
            "reply": "I'm not fully sure which category fits best. Please choose the option that feels closest to what you're experiencing.",
            "error": str(e)
        }), 500
